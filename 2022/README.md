...
* **Taller 3: Introducción al análisis exploratorio de datos espaciales con GeoDa** Lluís Vicens (SIGTE) **[Presentación](https://docs.google.com/presentation/d/1novzo2vYO0m8AeHanivZ_IZUTrNIJpbnC1So7FYwLnw/edit#slide=id.p)** Podéis descargar los datos de la exposición [aquí](data/GEODA_JSL.gpkg)
